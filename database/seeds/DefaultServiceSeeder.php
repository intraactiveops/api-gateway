...
class DefaultServiceSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $services = [
          ...
          ["id" => 3, "description" => "Auth", "link" => $baseUrl . "/api-gateway/public/api"],
          ["id" => 4, "description" => "Role", "link" => $baseUrl . "/api-gateway/public/api"],
          ["id" => 5, "description" => "Service Action", "link" => $baseUrl . "/api-gateway/public/api"],
          ["id" => 6, "description" => "Company", "link" => $baseUrl . "/api-gateway/public/api"]
        ];
        $actions = [
          // USER
